		...
		<view class="wrapper">
			<view class="input-content">
				...
				<view class="input-item">
					...
					<input type="text" v-model="password" placeholder="请输入新的密码" placeholder-class="input-empty" maxlength="20" password/>
				</view>
				<view class="input-item">
					<text class="tit">密码确认</text>
					<input type="text" v-model="password" placeholder="请再次输入新的密码" placeholder-class="input-empty" maxlength="10" password/>
				</view>
			...
			<button class="confirm-btn" @click="toUpdatePassword" :disabled="logining">修改密码</button>
		</view>
	</view>
</template>

<script>
	import { updatePassword, getAuthCode } from '@/api/member.js';
	export default {
		data() {
			return {
				logining: false,
